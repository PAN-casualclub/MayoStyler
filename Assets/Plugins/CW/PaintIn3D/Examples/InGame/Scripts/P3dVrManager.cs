	...
	public class P3dVrManager : MonoBehaviour
	{
		...
		protected virtual void LateUpdate()
		{
			...
			if (camera != null)
			{
				...
				if (Physics.Raycast(ray, out hit, simulatedReach, PaintTarget) == true)
				{
...
namespace PaintIn3D
{
	...
	public class P3dVrManager_Editor : CwEditor
	{
		protected override void OnInspector()
		{
			...
			Draw("PaintTarget", "This key allows you to simulate a right hand VR grip.");
